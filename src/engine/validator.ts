...
export const ACTION_PHRASES: Record<string, ActionSpec> = {
  ...
  jump: { action: 'jump' },
  hops: { action: 'jump' },
  bounces: { action: 'bounce' },
  bounce: { action: 'bounce' },
  recoils: { action: 'recoil' },
  recoil: { action: 'recoil' },
  'steps back': { action: 'recoil' },
  ...
  'puts hands on hips': { action: 'handsOnHips' },
  'put hands on hips': { action: 'handsOnHips' },
  'stands with hands on hips': { action: 'handsOnHips' },
